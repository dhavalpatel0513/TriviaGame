...
var questions = [{
    ...
    question: "Who sang the desert rose song?",
    answerList: ["Sting","Enrique Iglesias","Shakira","Akon"],
    answer: 0
},{
    question: "where is the world's tallest statue located?",
...
$("#start").on("click", function() {
    ...
    // Submit button
    $("#submit").html("<button id='done' class='startbtn'>Done</button>");
